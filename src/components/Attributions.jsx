...
export default function Attributions() {
    ...
    return (
        <motion.div           
            ...
            className="col-start-2 col-end-12 md:col-span-3 lg:col-start-5 lg:col-end-8 row-span-2 backdrop-blur-xl rounded-sm border border-gray-500 p-4 text-wrap overflow-y-scroll"
            >
