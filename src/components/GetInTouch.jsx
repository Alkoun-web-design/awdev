  ...
  const [index, setIndex] = React.useState(0);
    ...
    return (
        <motion.div           
            ...
            className="col-start-2 col-end-12 md:col-span-4 lg:col-start-2 lg:col-end-5 row-span-2 backdrop-blur-xl rounded-sm border border-gray-500 p-4 text-wrap overflow-y-scroll"
            >
