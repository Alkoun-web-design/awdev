...
const otherProjects = [
        ...
        },
        {
            ...
            description: <div className='mx-2 mt-2 mb-4'> 
                ...
                <p className="m-2">The challenge was to maintain interactivity and reactivity available in other libraries and frameworks while maintaining better crawlability of the website and its content.</p>
                <p className="m-2">By maintaining the original stack and simply adding Alpine.js for reactivity, we were able to achieve the benefits of React without the drawbacks affecting SEO and build complexity, whilst using a cleaner UI and better UX for visitor satisfaction.</p>
    ...
    const freelanceProjects = [
        {
            ...
            description: <div className='mx-2 mt-2 mb-4'> 
                ...
                <p className='m-2'>The Psychologist Ms.Iqra Naz benefitted from being able to reach new client and also establish an online presence.</p>
                <p className='m-2'>I had created an earlier version with HTML, CSS and JavaScript and publisehd that as a wordpress theme to allow Ms. Iqra Naz to blog using wordpress.
                 However the charges of hosting the website and paying for the domain name, added to her costs. The previous design of the website was also lackluster.</p>
        ...
        },
        {
            ...
            description: <div className='mx-2 mt-2 mb-4'> 
                ...
                <p className="m-2">After completing a UI and UX course on Udemy, I focus entirely on the design and aspects of the website and opted to use a builder to ensure my focus would not deviate towards programming and coding. For this instance, I opted to use the Divi Builder with their theme and custom made components.</p> 
        ...
        // },
        {
            name: 'AWDev website',
            description: <div className='mx-2 mt-2 mb-4'> 
                <p className="m-2">I rebuilt and redesigned my portfolio website to showcase the tech stack used, my experience, my projects with a little bit about me.</p> 
        ...
        // },
        {
            ...
            description: <div className='mx-2 mt-2 mb-4'> 
                ...
                <p className="m-2">The challenges revolved around using 3D assets with the least amount of impact on load times with the intention of communicating the message and atmosphere of a birthday party.</p>
        ...
        },
        {
            ...
            description: <div className='mx-2 mt-2 mb-4'> 
                <p className="m-2">A personal project that displays the value of spot cryptocurrencies on binance, built using solid.js through the astro.js framework and Node.js on the backend that communicates with binance and the client through websockets.</p> 
                <p className="m-2">The project was built initially to aid in trading on cryptocurrencies on binance's platform.</p>
                <p className="m-2">The challenge was to manipulate and base calculations on binance's own data every second on all spot cryptocurrencies, and then send the data back to the client for presentation.</p>
        ...
        },
        {
            ...
            description: <div className='mx-2 mt-2 mb-4'> 
                ...
                <p className="m-2">The challenge was to provide the client with a quick e-commerce website and dashboard that they could themselves manage.</p> 
                <p className="m-2">I used Shopify's frontend framework called hydrogen that is connected to the users shopify dashboard through APIs. This allowed for a quicker development time and more familiarity for the client.</p> 
        ...
        },
        {
            ...
            description: <div className='mx-2 mt-2 mb-4'>
                ...
                <p className="m-2">I learnt how to build the website using React and Tailwind CSS and then statically generate files to be hosted on a traditional web hosting platform.</p> 
            </div>,
        ...
        },
        {
            ...
            description: <div className='mx-2 mt-2 mb-4'> 
                ...
                <p className="m-2">The website would be a all in one platform for all tutors, admins, counsellors, and soon students for interacting with the academy. </p>
                ...
                <p className="m-2">I learnt typescript with react, integrating a backend which responded efficiently to fetch calls using React Query, restricted routes in React which could only be accessed after emails and passwords matched, and user sessions could be generated and stored.</p>
            </div>,
